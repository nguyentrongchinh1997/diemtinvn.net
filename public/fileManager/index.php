...
//Application Title
define('APP_TITLE', 'BKiT File Manager');
...
$auth_users = array(
    'bkitsoftware' => '$2y$10$gAhCASrUWxZC04E.EZG3H.M44D.EIVMPS.jg31fg8a0/.E.nYx4RW', //admin@123
    'user' => '$2y$10$gAhCASrUWxZC04E.EZG3H.M44D.EIVMPS.jg31fg8a0/.E.nYx4RW' //12345
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://bkitsoftware.com/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">BkitSoftware.com</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        <?php if (!FM_READONLY && $owner != "root"): ?>
            
                        <a title="<?php echo lng('Edit') ?>" <a href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&env=ace">Chỉnh sửa</a>
                        <?php endif; ?>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE): 
    ...
    <script>
        ...
        // alert( {path:"ace/mode/<?php echo $ext; ?>", inline:true});
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'BkIT File Manager';
